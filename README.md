...
3. With the server also running [Link to Server API here](https://github.com/nss-day-cohort-54/rare-v2-api-donkey-kong-api), check that the login, register, and logout functionality is in working.
